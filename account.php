      ...
      <nav id="nav-main">
         <ul id="active"> 
            ...
            <form id="logout" action="">
             	...
             	<input type="button" href="logout.php" id="logoutBtn" src="" alt="logout" value="Logout"/>
   ...
   <main>
   	  ...
   	  <section class="container">
      	<div class="intro">
			<h1>My Account</h1> 
      	    <h2></h2>
      		<p>Create ability to change password and maybe email, too.  Show members their name and subscription status (or not, just leave it up to them to mark it on their calendar when to cancel. If this is legal practice, do it.). And perhaps a paypal link will suffice. Make it possible for them to cancel subscription either on this website or in their paypal account. Logout Button </p>
				...
				<div class="form-group">
					...
					<div>
						 <textarea class="form-control" name="CustomText" rows="4" cols="40"></textarea>
							<input type="button" value="Contact"> <br><br>		
					</div>
				</div>
			</div>
			<div class="form-group">
